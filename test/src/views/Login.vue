    ...
    <div style="margin: 200px auto; background-color: #fff; width: 350px; height: 350px; padding: 20px; border-radius: 10px">
      ...
      <el-form :model="user" :rules="rules" ref="userForm">
        ...
        <el-form-item style="margin: 10px 0; text-align: left">
          <el-button style="width: 150px; height: 40px;color: black"  size="medium"  autocomplete="off" @click="$router.push('/register')">没有账号立即注册</el-button>
          <el-button type="primary" style="width: 150px; height: 40px;" size="medium" autocomplete="off" @click="login">登录</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
